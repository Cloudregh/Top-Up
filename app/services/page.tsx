...
export default function Services() {
  return (
    <>
      <InfoHero eyebrow="Pharmacy Services" title="Care beyond the counter" intro="Visit any of our branches and receive appropriate care specific to your health needs. Begin by selecting the service(s) you require, and we will assist you." image="pharmacy" />
