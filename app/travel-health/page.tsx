...
export default function Page() {
  return (
    <>
      ...
      <Section waitingFor="POST /enquiries (forms currently hand off to WhatsApp)"><div className="mx-auto max-w-2xl"><WhatsAppForm heading="Travel Health enquiry" fields={[
