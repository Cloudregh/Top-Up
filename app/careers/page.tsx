...
export default function Careers() {
  return (
    <>
      <InfoHero eyebrow="Careers" title="Join the Top-Up team" intro="Help us deliver quality healthcare across Ghana. Tell us about yourself and the role you're interested in." image="pharmacy" />
